...
#define __MUTEGEAR_ATOMIC_OR_RELAXED_PTRDIFF(destination, value, original_storage) ((original_storage) = _InterlockedOr64_HLEAcquire(destination, (ptrdiff_t)(value)))
#define __MUTEGEAR_ATOMIC_AND_RELAXED_PTRDIFF(destination, value, original_storage) ((original_storage) = _InterlockedAnd64_HLEAcquire(destination, (ptrdiff_t)(value)))
...
#define __MUTEGEAR_ATOMIC_OR_RELAXED_PTRDIFF(destination, value, original_storage) ((original_storage) = _InterlockedOr_HLEAcquire(destination, (ptrdiff_t)(value)))
#define __MUTEGEAR_ATOMIC_AND_RELAXED_PTRDIFF(destination, value, original_storage) ((original_storage) = _InterlockedAnd_HLEAcquire(destination, (ptrdiff_t)(value)))
